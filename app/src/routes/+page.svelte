<script lang="ts">
    import { checkWallet, connectWallet, disconnectWallet } from '$lib/wallet/helpers/connect-wallet';
      ...
      <div class="container mx-auto px-4">
        <div class="flex justify-between items-center h-16">
          ...
          <div class="flex items-center space-x-4">
            ...
            >
              {$walletStore.walletAddress ? $walletStore.walletAddress : 'Connect Wallet'}
            </button>
          </div>
        </div>
      </div>
